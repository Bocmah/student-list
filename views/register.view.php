...
<form method="post" action="register">
    ...
    <input type="number" min="1900" max="2008" step="1" id="birth_year" name="birth_year"
           value="<?php echo isset($values["birth_year"]) ? htmlspecialchars($values["birth_year"]) : ""; ?>"><br>
    ...
    <input type="number" id="exam_score" name="exam_score" min="0" max="300"
           value="<?php echo isset($values["exam_score"]) ? htmlspecialchars($values["exam_score"]) : ""; ?>"><br>
